  ...
  <div class="hero_section">
    ...
    <div class="hero_content">
      <div class="hero_logos">
        <img
          class="hero_logo"
          src="/resources/images/white.png"
          alt="OurChat Icon"
        />
        <img
          class="hero_logo"
          src="/resources/images/logo_text.png"
          alt="OurChat Text Logo"
        />
        <img
          class="hero_logo"
          src="/resources/images/green.png"
          alt="OurChat Icon"
        />
      </div>
      ...
      <div class="hero_buttons">
        ...
        <div class="download_dropdown">
          ...
          <div class="dropdown_content">
            <a
              href="https://github.com/SkyUOI/OurChat/releases"
              target="_blank"
              >{{ t("hero.github") }}</a
            >
            <a
              href="https://gitee.com/SkyUOI/OurChat/releases"
              target="_blank"
              >{{ t("hero.gitee") }}</a
            >
          </div>
